...
func RegisterFlags(flagSet *flag.FlagSet) {
	...
	flagSet.Int("network-threads-per-channel", 0, "number of threads in each channel for processng inbound packets. If 0, the link endpoint will divide GOMAXPROCS evenly among the number of channels specified by num-network-channels.")
