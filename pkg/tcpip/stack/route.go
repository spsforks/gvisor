...
type Route struct {
	...
	// mtu is the maximum transmission unit supported by this route if present.
	mtu uint32
}
...
func makeLocalRoute(netProto tcpip.NetworkProtocolNumber, localAddr, remoteAddr tcpip.Address, outgoingNIC, localAddressNIC *nic, localAddressEndpoint AssignableAddressEndpoint) *Route {
	...
	return makeRouteInner(netProto, localAddr, remoteAddr, outgoingNIC, localAddressNIC, localAddressEndpoint, loop, 0) // TODO(ahamirwasia): Not sure what to pass in here.
}
